...
- **Account Termination**: Schoolsquid reserves the right to suspend or terminate user accounts, with or without notice, in its sole discretion. Grounds for such suspension or termination may include, but are not limited to, violation of these Terms, fraudulent activity, or illegal conduct.
...
- **Sexual Misconduct**: Engaging in sexually explicit communications or activities with users or AI-generated characters, particularly involving minors or where the interaction is inappropriate. Fictional scenarios of a sexual nature involving minors are explicitly prohibited.

- **Illegal Roleplay**: Engaging in roleplay that involves illegal acts, including but not limited to:
  - Scenarios depicting illegal activities such as "I prepare to rob the bank" when roleplaying with a character named "Bank Security Officer."
  - Non-consensual interactions such as "I touch her arm without her permission" directed towards a character named "Shy Girl."
  - Self-harm or suicide references, such as "I hurt myself intentionally."
...
- **Content Moderation**: Schoolsquid reserves the right to monitor, review, remove, or reclassify content that violates these Terms or applicable laws. Schoolsquid retains the sole discretion to determine whether content is appropriate.

- **Platform Content Ownership**: All content generated by Schoolsquid or any of its partners, including but not limited to character voices, designs, or backstories, is the exclusive property of Schoolsquid. You agree not to use any such content for commercial purposes without prior explicit written consent from Schoolsquid. All voices created and/or uploaded through the Platform are processed and stored by Fish.audio, and as such, are subject to Fish.audio's Terms of Service and other applicable policies.

- **Content Removal Requests**: If you encounter any content that infringes on your copyright, please don't hesitate to reach out to us at **copyright@serika.dev**. We are committed to promptly addressing your concerns.
...
- **Payment Disputes**: Users agree to resolve any disputes regarding charges with Schoolsquid directly. Any attempt to initiate a chargeback may result in the suspension or termination of your account.
...
These Terms are governed by and shall be construed in accordance with the laws of the Netherlands, without regard to its conflict of laws principles. You agree to submit to the exclusive jurisdiction of the competent courts of the Netherlands for any dispute arising under these Terms, unless otherwise agreed in arbitration. This choice of jurisdiction is intended to ensure consistent application of Dutch laws and reduce exposure to conflicting international legal standards.

---

## 12. Modifications and Updates

Schoolsquid reserves the right to modify, amend, or discontinue the Platform, Services, or these Terms at any time without prior notice. Modifications will be effective upon publication, and your continued use of the Platform following any updates constitutes acceptance of the revised Terms.
...
These Terms, together with any additional policies incorporated by reference, constitute the entire agreement between you and Schoolsquid concerning the Platform and supersede all prior agreements, representations, and understandings.
